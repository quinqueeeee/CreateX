...
export default function BenefitsInterior() {
	return (
		<>
			<section class="benefits">
				<div class="benefits__container _container">
					<h2 class="header--title benefits-header-title">Our benefits</h2>
			...
			<div class="duscuss-btn">
				<button class="discuss">Discuss a project</button>
			</div>
		</>
	)
}