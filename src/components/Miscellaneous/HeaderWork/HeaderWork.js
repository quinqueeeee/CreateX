...
export default function HeaderWork() {
	return (
		<header id='header' class="header-333">
			<div class="header__container _container">
				<nav class="nav">
					...
					<ul class="nav__list">
						...
						<li class="nav__item">
							<a href="work.html" class="nav__link nav__link-active">
								Work
							</a>
						</li>
						<li class="nav__item">
			...
			<div class="hero">
				<div class="hero__container _container">
					...
					<p class="hero-text">Our portfolio represents 20 years of construction experience backed by a passion
						for perfect client service, quality and innovations in consctuction industry.</p>
				</div>
			</div>
		</header>
	)
